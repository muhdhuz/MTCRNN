...
def listDirectory_all(directory,fileExtList,topdown=True,regex=None):
...
class AudioDataset(data.Dataset):	 
	def __init__(self, datadir, sr, seqLen, stride, 
				extension='.wav', paramdir=None, prop=None, 
