...
parser.add_argument('--hidden_size', type=int, default=300, help='no. of hidden nodes for each GRU layer')
...
parser.add_argument('--input_size', type=int, default=16, help='input vector size: audio + conditional vector')
